import { Image, StatusBar, StyleSheet, TextInput, TouchableOpacity, View,Text, ScrollView, TouchableWithoutFeedback, Keyboard } from 'react-native';
          ...
          <SafeAreaView style={{ flex: 1 }}>
            ...
            <View style={styles.forecast_container}>
              ...
              <View style={{gap:verticalScale(8)}}>
                <Text style={{textAlign:'center',fontWeight:'bold',color:'white',fontSize:moderateScale(64),marginLeft:scale(10)}}>{current?.temp_c?.toFixed(2)}&#176;</Text>
